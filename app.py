...
with col2:
    ...
    st.markdown("""
        <div style="text-align: center;">
           <h3 style="font-size: 20px; margin-bottom: 0;"><i>Provérbios 16:3 "Consagre ao Senhor tudo o que você faz, e os seus planos serão bem-sucedidos."</i><h3>
           <h1 style="font-size: 25px; margin-top: 0; margin-bottom: 0; color: orange;">TIME ELITE</h1>
            <h1 style="font-size: 25px; margin-top: 0; color: green;">🚀 RUMO AOS 180 MILHÕES!</h1>
        </div>
    """, unsafe_allow_html=True)
