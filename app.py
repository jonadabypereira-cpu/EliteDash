...
with col_titulo:
    ...
    <div style="text-align:center; margin-bottom:0px;">
        <div style="color:white; font-size:20px; font-style:italic; margin-top:10px;">
            Provérbios 16:3 "Consagre ao Senhor tudo o que você faz, e os seus planos serão bem-sucedidos."
        </div>
        <div style="color:#00b050; font-size:30px; font-weight:700; margin-top:5px; letter-spacing:8px;">
...
for i in range(0, len(resultado), cards_por_linha):
    ...
    for j in range(cards_por_linha):
        if i + j < len(resultado):
            ...
            percentual_esperado_decimal = (dias_uteis_passados / dias_uteis_mes)

            if percentual_meta >= 1:
                cor = "#2e871e"
            elif percentual_meta >= 0.85:
                cor = "#2299f7"
            elif percentual_meta >= percentual_esperado_decimal:
                cor = "#ac7e11"
            else:
                cor = "#b62828"
